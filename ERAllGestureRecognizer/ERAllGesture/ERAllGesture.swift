...
/*
 usage:
    ...
    add gesture:
        yourObjToStoreMe.erAllGesture = ERAllGesture(view: your_view)
    remove gesture:
        yourObjToStoreMe.erAllGesture = nil
    disable gesture:
        yourObjToStoreMe.erAllGesture.isGestureEnabled = false
    advanced usage:
        ...
        yourObjToStoreMe.erAllGesture = ERAllGesture(transformView: your_view_to_transform, gestureView: your_view_to_recieve_gesture)

 */

class ERAllGesture: NSObject, UIGestureRecognizerDelegate {
